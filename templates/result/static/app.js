...
form1.addEventListener("submit", (event) => {
    ...
    if(input_num_ch.innerHTML.indexOf("ヶ所") == -1){
        ...
        if(num_panels_in[0].innerHTML.indexOf("枚") == -1){
            ...
            new_input0 = '<div class="ng num_gimick0"><!-- 3 --><label>ギャップ:</label><input type="number" class="gimick_s_1" id="ch_ps0" name="num_checkpoint" min="0" size="10" required /></div><!-- 3 -->';
            new_input1 = '<div class="ng num_gimick1"><!-- 3 --><label>傾斜路:</label><input type="number" class="gimick_s_1" id="ch_ps1" name="num_checkpoint" min="0" size="10" required /></div><!-- 3 -->';
            new_input2 = '<div class="ng num_gimick2"><!-- 3 --><label>バンプ:</label><input type="number" class="gimick_s_1" id="ch_ps2" name="num_checkpoint" min="0" size="10" required /></div><!-- 3 -->';
            new_input3 = '<div class="ng num_gimick3"><!-- 3 --><label>障害物:</label><input type="number" class="gimick_s_1" id="ch_ps3" name="num_checkpoint" min="0" size="10" required /></div><!-- 3 -->';
            new_input4 = '<div class="ng num_gimick4"><!-- 3 --><label>緑被災者:</label><input type="number" class="gimick_s_1" id="ch_ps4" name="num_checkpoint" min="0" size="10" required /></div><!-- 3 -->';
            new_input5 = '<div class="ng num_gimick5"><!-- 3 --><label>黒被災者</label><input type="number" class="gimick_s_1" id="ch_ps5" name="num_checkpoint" min="0" size="10" required /></div><!-- 3 -->';
